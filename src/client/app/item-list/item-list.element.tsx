        ...
        if (!element.items) {
            ...
            return <template>
                ...
                <div class="item-list__navigation">
                    {
                        element.page > 0 ? <LinkElement path={`/${element.type}/${element.page}`} class="item-list__navigation-button">&lt; previous</LinkElement> : ''
                    }
                    <LinkElement path={`/${element.type}/${element.page + 2}`} class="item-list__navigation-button"  > next &gt;</LinkElement>
                </div>
            </template>;
        }
    },
